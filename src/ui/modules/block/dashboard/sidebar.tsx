...
import { BarChart3, CreditCard, DollarSign, Home, Settings, Shield, Users } from "lucide-react"
...
export function DashboardSidebar() {
  const nav = [
    ...
    { label: "Support", icon: Shield, href: "#" },
  ]
  ...
  return (
    ...
    >
      <div className="h-[64px] flex items-center px-5 text-white text-[18px] font-semibold">KleverPay</div>
